...
void man(char * name)
{
    ...
    else if(strcmp(name,"read") == 0)
    {
        ...
        printf("Usage :read File name No_of_Bytes_to Read\n");
    }
    ...
    {
        printf("Description:Used to Display information og file \n");
...
int fsat_file(int fd)
{
    ...
    printf("File Size : %d\n",temp->FileSize);
    printf("Actual File size ",temp->FileActualSize);
    printf("Link count : %d\n",temp->LinkCount);
